# Heads Up FastAPI Backend

Minimal async FastAPI service for central Heads Up user accounts and de-identified daily report sync.
...
`POST /api/v1/reports/sync` accepts authenticated daily Heads Up reports and stores them in the database.
