...
<head>
  ...
  <title>Heads Up Data Dashboard</title>
  <style>
    :root {
      color-scheme: dark;
      --bg: #071426;
...
<head>
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <title>Download Heads Up APK</title>
  <style>
    :root {
      color-scheme: dark;
      --bg: #071426;
...
<body>
  <main class="card">
    ...
    <p>點擊下方按鈕下載目前伺服器上的 Heads Up demo APK。下載後 Android 會要求允許「安裝未知來源應用程式」。</p>
    <a class="download" href="/downloads/headup-debug.apk">下載 Heads Up APK</a>
    <div class="note">
...
async def download_debug_apk() -> Response:
    ...
    if apk_path is None:
        raise HTTPException(
            status_code=404,
            detail="Heads Up debug APK was not found. Run :app:assembleDebug before downloading.",
        )
    return FileResponse(
        apk_path,
        media_type="application/vnd.android.package-archive",
        filename="Heads Up-demo-debug.apk",
    )
