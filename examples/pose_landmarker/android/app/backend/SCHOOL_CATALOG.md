...
Heads Up accepts only CSV or JSON downloaded from an official Taiwan government open-data dataset. The importer stores the dataset URL and school-year version on every row and does not scrape search engines or community-maintained lists.
